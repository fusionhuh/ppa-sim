...
#set_input_delay -clock clk -max 0.2 [get_ports {x1 x2 cin}]
#set_input_delay -clock clk -min -0.2 [get_ports {x1 x2 cin}]

# ------------------------- Output constraints ---------------------------------

#set_output_delay -clock clk -max 0.2 [get_ports {s cout p_out g_out}]
#set_output_delay -clock clk -min -0.2 [get_ports {s cout p_out g_out}]
